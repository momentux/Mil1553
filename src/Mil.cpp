...
char errorCode[1000];
static UINT16 buffer_6_1[64], buffer_6_2[64], buffer_6_3[64], buffer_6_4[64];
...
INT16 CreateBusFrame() {
  ...
  //////////////////////////////////////////////////////////////////////////
  // only for RT-RT
  iResult = mcx_Create_BusList_Element(DeviceId, ICD_6_1, cmd_6_1_tx, 0x80 | RT2RT_FORMAT, cmd_6_1_rx, rxStt, txStt);
  if (iResult < 0)
    return iResult;
  iResult = mcx_Create_BusList_Element(DeviceId, ICD_6_2, cmd_6_2_tx, 0x80 | RT2RT_FORMAT, cmd_6_2_rx, rxStt, txStt);
  if (iResult < 0)
    return iResult;
  iResult = mcx_Create_BusList_Element(DeviceId, ICD_6_3, cmd_6_3_tx, 0x80 | RT2RT_FORMAT, cmd_6_3_rx, rxStt, txStt);
  if (iResult < 0)
    return iResult;
  iResult = mcx_Create_BusList_Element(DeviceId, ICD_6_4, cmd_6_4_tx, 0x80 | RT2RT_FORMAT, cmd_6_4_rx, rxStt, txStt);
  if (iResult < 0)
    return iResult;
  //////////////////////////////////////////////////////////////////////////
  ...
  iResult = mcx_Create_Element_DataBlock(DeviceId, ICD_6_1, 0, buffer_6_1, 64);
  if (iResult < 0)
    return iResult;
  iResult = mcx_Create_Element_DataBlock(DeviceId, ICD_6_2, 0, buffer_6_2, 64);
  if (iResult < 0)
    return iResult;
  iResult = mcx_Create_Element_DataBlock(DeviceId, ICD_6_3, 0, buffer_6_3, 64);
  if (iResult < 0)
    return iResult;
  iResult = mcx_Create_Element_DataBlock(DeviceId, ICD_6_4, 0, buffer_6_4, 64);
  if (iResult < 0)
    return iResult;
  /////////////////////////////////////////////////////////////////////////////

...
struct ICD_6_1_data
{
    ...
    double cnexy = 0.0;
    double cneyz = 0.0;
    double pplon; // fdm/jsbsim/position/long-gc-deg
    double presentalt;                   // fdm/jsbsim/position/h-sl-meters
    double gcstreeringerror = 0.0;
    double pplat; // fdm/jsbsim/position/lat-gc-deg
    UINT16 imumodeword2 = 0;
    double rollrate;  // fdm/jsbsim/velocities/phidot-rad_sec
    double pitchrate; // fdm/jsbsim/velocities/thetadot-rad_sec
    double yawrate;   // fdm/jsbsim/velocities/psidot-rad_sec
};
